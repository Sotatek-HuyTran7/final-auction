...
from auction.operations import createAuctionApp, setupAuctionApp, placeBid, closeAuction, getContracts
...
def simple_auction():
    ...
    creator = Account(to_private_key(
